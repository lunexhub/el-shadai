...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "WhatsApp",
      details: ["082 718 1167"],
      action: "https://wa.me/27827181167?text=Hello!%20I%20would%20like%20to%20book%20an%20appointment.",
      actionLabel: "Chat Now",
    },
    {
      icon: Mail,
      title: "Email",
      details: ["info@elshadaiadonai.co.za"],
      action: "mailto:info@elshadaiadonai.co.za",
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-card rounded-2xl p-8 md:p-12 shadow-card text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* WhatsApp Booking */}
                <a
                  href="https://wa.me/27827181167?text=Hello!%20I%20would%20like%20to%20book%20an%20appointment%20at%20El%20Shadai%20Adonai%20Maternity%20Services."
                  target="_blank"
